...
const About = () => {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
          I'm Sagar Koshti, a creative Frontend Developer who transforms ideas
          into exceptional digital experiences. With expertise in React.js,
          Next.js, and modern web technologies, I craft intuitive and performant
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
          ...
          <p className="text-slate-600">
            Dedicated to creating clean, efficient, and maintainable code that
            makes a difference.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
          ...
          <p className="text-slate-600">
            Always exploring and mastering new technologies to stay ahead of the
            curve.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={skill}
              className="bg-gradient-to-r from-violet-50 to-indigo-50 px-4 py-2 rounded-lg text-center"
            >
    ...
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-slate-600">
          Building exceptional digital experiences for over 2 years
        </p>
      </div>

      <div className="space-y-8">
        {/* Existing Experience 1 - Senior Frontend Developer */}
        {/* Existing Experience 2 - Frontend Developer */}

        {/* Experience 3 - Web Application Developer at Quickint Solutions */}
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
            ...
            <ul className="text-slate-600 space-y-3">
              ...
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Created reusable components and ensured clean code practices
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>Integrated REST APIs and optimized performance</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>Ensured cross-device compatibility for enhanced UX</span>
              </li>
            </ul>
          </div>
        </div>

        {/* Experience 4 - Internship at Quickint Solutions */}
        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-violet-500 before:to-indigo-500">
          <div className="absolute -left-[3px] top-0 w-1.5 h-1.5 rounded-full bg-violet-500"></div>
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
            ...
            <ul className="text-slate-600 space-y-3">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Worked on real-world projects and collaborated with senior
                  team members
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Applied theoretical knowledge to solve practical development
                  problems
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Enhanced problem-solving and technical skills in a production
                  environment
                </span>
              </li>
            </ul>
        ...
        {/* Experience 5 - Android Developer at Beetonz Infotech */}
        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-violet-500 before:to-indigo-500">
          <div className="absolute -left-[3px] top-0 w-1.5 h-1.5 rounded-full bg-violet-500"></div>
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
            ...
            <ul className="text-slate-600 space-y-3">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>Developed Android apps using Java and XML</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>Integrated REST APIs and managed SQLite databases</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Improved app performance and handled testing/debugging
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-violet-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  Collaborated in Agile teams through code reviews and feature
                  implementation
                </span>
              </li>
            </ul>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-violet-500 before:to-indigo-500">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
            ...
            <div className="space-y-3">
              <p className="text-slate-600">
                Focused on web technologies and software development with
        ...
        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-violet-500 before:to-indigo-500">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-slate-100">
            ...
            <div className="space-y-3">
              <p className="text-slate-600">
                Foundation in programming and computer science fundamentals
                including:
              </p>
              <ul className="text-slate-600 space-y-2 ml-4">
                <li className="flex items-center gap-3">
      ...
      <div className="bg-gradient-to-r from-violet-50 to-indigo-50 p-8 rounded-2xl border border-violet-100">
        ...
        <p className="text-slate-600 mb-4">
          Beyond formal education, I'm committed to continuous learning and
  ...
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-br from-slate-50 to-violet-50"
    >
